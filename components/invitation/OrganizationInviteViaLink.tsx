...
interface OrganizationInviteViaLinkProps {
  organization: Organization;
}

const OrganizationInviteViaLink = ({ organization }: OrganizationInviteViaLinkProps) => {
...
export default OrganizationInviteViaLink; 